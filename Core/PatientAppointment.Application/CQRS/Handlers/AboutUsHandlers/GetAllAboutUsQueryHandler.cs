...
{
    public class GetAllAboutUsQueryHandler : IRequestHandler<GetAllAboutUsQuery, List<AboutUsResult>>
    {
        private readonly IRepository<AboutUs> _repository;
        private readonly IMapper _mapper;

        public GetAllAboutUsQueryHandler(IRepository<AboutUs> repository, IMapper mapper)
        {
            _repository = repository;
            _mapper = mapper;
        }

        public async Task<List<AboutUsResult>> Handle(GetAllAboutUsQuery request, CancellationToken cancellationToken)
        {
