...
{
    public class GetAllBloodTypeQueryHandler : IRequestHandler<GetAllBloodTypeQuery, List<BloodTypeResult>>
    {
        private readonly IRepository<BloodType> _repository;
        private readonly IMapper _mapper;

        public GetAllBloodTypeQueryHandler(IRepository<BloodType> repository, IMapper mapper)
        {
            _repository = repository;
            _mapper = mapper;
        }

        public async Task<List<BloodTypeResult>> Handle(GetAllBloodTypeQuery request, CancellationToken cancellationToken)
        {
