...
{
    public class GetAllPolyclinicQueryHandler : IRequestHandler<GetAllPolyclinicQuery, List<PolyclinicResult>>
    {
        private readonly IRepository<Polyclinic> _repository;
        private readonly IMapper _mapper;

        public GetAllPolyclinicQueryHandler(IRepository<Polyclinic> repository, IMapper mapper)
        {
            _repository = repository;
            _mapper = mapper;
        }

        public async Task<List<PolyclinicResult>> Handle(GetAllPolyclinicQuery request, CancellationToken cancellationToken)
        {
